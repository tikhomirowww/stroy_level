          ...
          <Box className='social_box' style={{ flexGrow: 0 }}>
            <div className='social_logo'>
                ...
                >
                    ...
                    drag
                    >
                    <InstagramIcon className='social' style={{color: 'white'}}  />
                    </motion.div>
                </Link>
                <Link
            ...
            <div className='numbers'>
                <a href='tel:+996505545945'  className="o">0505 545-945</a>
                <a href='tel:+996555545945'  className="mega">0555 545-945</a>
            </div>
