...
const actions = [
  {
    icon: <EmailIcon />,
    name: "Email",
    path: "mailto: stroylevel.kg@gmail.com",
  },
  {
    icon: <InstagramIcon />,
    name: "Instagram",
    path: "https://www.instagram.com/stroy_level.kg/",
  },
];
    ...
    <>
        ...
        <Fade in={open}>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Box className="modal_form" sx={style}>
              <Typography id="spring-modal-title" variant="h6" component="span">
                Оформить замер
              </Typography>
                ...
                >
                  ...
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      sx={{ mb: 2 }}
                    >
                      <MenuItem value={"Лофт перегородка"}>
                        Лофт перегородка
                      </MenuItem>
                  ...
                  <TextField
                    ...
                    value={number}
                    name="entry.1599083215"
                    id="standard-basic"
                    size="small"
                    type="tel"
                    label="Номер What's App"
                    variant="outlined"
                  />
                  <Button
                    onClick={() => sendData(name, number, type)}
                    className="modal_btn"
                  >
                    Отправить заявку
                  </Button>
      ...
      <div className="about">
        ...
        <div className="about_bg">
          <img
            src="https://bigfoto.name/uploads/posts/2022-02/1645948763_2-bigfoto-name-p-lestnitsa-loft-fon-dlya-shopa-v-interere-4.jpg"
            alt="error"
          />
          {/* cards  */}
            ...
            >
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  >
                    Стеклянные перегородки в металлическом профиле успешно
                    применяются при офрмлении помещений в стиле ЛОФТ.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
              ...
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    color="text.secondary"
                  >
                    Душевые перегородки из стекла очень популярны в современных
                    интерьерах ванных комнат.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
              ...
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    color="text.secondary"
                  >
                    Биокамин — это современное устройство с живым пламенем, не
                    нуждающееся в дымовой вентиляции и не предполагающее
                    использования деревянных поленьев.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
              ...
              <CardActionArea>
                ...
                <CardContent>
                  ...
                  <Typography
                    ...
                    color="text.secondary"
                  >
                    Подвесные реечные потолки и грильято открыают новую
                    перспективу в архитектуре подвесных потолков.
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
            ...
            <div className="icon_container">
              <div className="why_icon">
                <img
                  width="100"
                  height="100"
                  src="https://cdn.onlinewebfonts.com/svg/img_515351.png"
                  alt="error"
                />
              </div>
            ...
            <div className="icon_container">
              <div className="why_icon">
                <img
                  width="100"
                  height="100"
                  src="https://uxwing.com/wp-content/themes/uxwing/download/tools-equipment-construction/tools-icon.png"
                  alt="error"
                />
              </div>
              <h2>
                Своё <br /> производство
              </h2>
            </div>
            <div className="icon_container">
              <div className="why_icon">
                <img
                  width="100"
                  height="100"
                  src="https://cdn-icons-png.flaticon.com/512/1156/1156728.png"
                  alt="error"
                />
              </div>
            ...
            <div className="icon_container">
              <div className="why_icon">
                <img
                  width="100"
                  height="100"
                  src="https://pechki.su/images/companies/1/montag/montag.png"
                  alt="error"
                />
              </div>
              <h2>
